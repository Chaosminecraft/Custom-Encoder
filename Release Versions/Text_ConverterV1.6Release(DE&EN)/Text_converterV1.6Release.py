    ...
    while True:
        try:
            ...
            if f == "en":
                ...
                print(f"anymore. It is on GitHub too\n")
                lang="en"
                content.close()
                main_thread()
                return
...
def calc():#the Calculator
    global confirm
    try:
        exec(open('calc.py').read())
        return
    except FileNotFoundError:
        print(f"\nCalculator file missing. :(\n")
        confirm="true"
                ...
                if answer.lower() == 'decode':
                    if text=="truehex":
                        ...
                        if recon.lower()=="false":
                            ...
                            placeholder="i'm pickle rick, look at me go."# YAY, unused content.
                    if text=="truebinary":
                        ...
                        if recon.lower()=="false":
                            ...
                            placeholder="Rick, i think i'm dead..."#Yet again... unused
                    else:
                        decode_s = input(">> ")
                        ...
                        if recon.lower()=="false":
                            ...
                            placeholder="i'm pickle rick, look at me go."#man, i'm good at that. *Smirking*
                    ...
                    if text=="truehex":
                        ...
                        if recon.lower()=="false":
                            ...
                            placeholder="i'm pickle rick, look at me go."#danm, that will Never ever been seen in the compiled version, except i may add something to view some variables...
                    if text=="truebinary":
                        a = input(">> ")
                        ...
                        if recon.lower()=="false":
                            ...
                            placeholder="Sub to Chaosminecraft"#Yes. :D
                    else:
                        encode_s = input(">> ")
                        ...
                        if recon.lower()=="false":
                            ...
                            placeholder="ich werde eventuell nie gehen oder gesehen werden."#Except here. (another God Damn secret string.)
...
def reconvert():#that function may be put away... but that asks if you wanna do an convertion again.
    global recon
    while True:
        if lang == "en":
...
def time():#just a normal clock.
    try:
        if lang == "en":
            now=datetime.now()
            s = datetime.strptime(now.strftime("%H:%M"), "%H:%M")
            print(s.strftime("%r"))
            return
        if lang == "de":
            now=datetime.now()
