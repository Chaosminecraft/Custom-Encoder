...
def start(): #for the reset command. not much.
    while True:
        main()
...
def main(): #Loading lang.txt and reading it
    ...
    while True:
        try:
            ...
            f = content.read()
            if f == "":
                print(f"Chaosminecraft, Fix that language problem. mail: {mail}")
                f = "en"
            ...
            if startup=="FALSE":
                ...
                if f.lower() == "en":
                    ...
                    print(f"Please fix me Chaosminecraft. mail adress: {mail}")
                    f = "en"
        ...
        try:
            try:
                try:
                    ...
                    if answer.lower() == "set language" or answer.lower() == "set lang":#to set a available language
